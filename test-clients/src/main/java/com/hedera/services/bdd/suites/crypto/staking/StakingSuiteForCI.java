...
import com.hedera.services.bdd.suites.HapiStakingSuite;
...
public class StakingSuiteForCI extends HapiStakingSuite {

    private static final Logger log = LogManager.getLogger(StakingSuiteForCI.class);
    ...
    public static void main(String... args) {
        new StakingSuiteForCI().runSuiteAsync();
    }
    ...
    @Override
    public List<HapiStakingSpec> getStakingSpecsInSuite() {
        return List.of(rewardsWorkAsExpected());
    }

    private HapiStakingSpec rewardsWorkAsExpected() {
        return defaultHapiSpec("rewardsWorkAsExpected")
                .given()
                .when()
                .then(
                runAndCollectResultsForStakingSpecsWithinPeriods(4,
                        List.of(
