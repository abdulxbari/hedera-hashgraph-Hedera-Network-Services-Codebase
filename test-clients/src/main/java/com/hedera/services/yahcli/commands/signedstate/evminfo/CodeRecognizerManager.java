...
public class CodeRecognizerManager {
    ...
    public class Distributor extends CodeRecognizer {
        ...
        public Distributor(Assembly assembly) {
            super(assembly);
        }
        ...
        public CodeRecognizer.@NotNull Results end() {
    ...
    public CodeRecognizerManager(Assembly assembly) {
        for (var recognizerKlass : recognizerClasses)
            try {
                recognizers.add(
                        recognizerKlass
                                .getDeclaredConstructor(Assembly.class)
                                .newInstance(assembly));
    ...
    static {
        ...
        if (false)
            System.out.printf(
                    "Assembly: %d CodeRecognizer subclasses found: %s%n",
                    recognizerClasses.size(), recognizerClasses);
    }
}
