...
public class DirectCallsTxProcessor {
    ...
    public TransactionProcessingResult execute(
        ...
        final long gasPrice =
                TxProcessorUtil.gasPriceTinyBarsGiven(
                        livePricesSource, consensusTime, isEthTx, HederaFunctionality.ContractCall);
        ...
        PrecompileMessage message =
                PrecompileMessage.builder()
                        .setLedgers(ledgers)
        ...
        long gasUsedByTransaction =
                TxProcessorUtil.calculateGasUsedByTX(
                        gasLimit, message, dynamicProperties.maxGasRefundPercentage());

        // return gas price to accounts
        final long refunded =
                isEthTx
                        ? TxProcessorUtil.calculateRefundEth(
                                gasLimit,
                                gasPrice,
                                mutableRelayer,
                                allowanceCharged,
                        ...
                        : TxProcessorUtil.calculateRefund(
                                gasLimit,
                                gasPrice,
                                gasUsedByTransaction,
                                updater.getSbhRefund(),
        ...
        TxProcessorUtil.sendFeesToCoinbase(
                updater, dynamicProperties, gasLimit, gasPrice, refunded);
        ...
        return TxProcessorUtil.buildTransactionResult(
                ...
                message.getExceptionalHaltReason(),
                Map.of());
    }
    ...
    private void callHtsPrecompile(PrecompileMessage message) {
        ...
        if (message.getGasRemaining() < gasRequirement) {
            ...
            message.setExceptionalHaltReason(
                    Optional.of(
