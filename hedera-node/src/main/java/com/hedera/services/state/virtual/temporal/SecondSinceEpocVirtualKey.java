...
public final class SecondSinceEpocVirtualKey implements VirtualLongKey {
    ...
    public SecondSinceEpocVirtualKey() {
        this(-1);
    }

    /**
     * @param value the long value of a second since the epoc
     */
    public SecondSinceEpocVirtualKey(final long value) {
        this.value = value;
    }
    ...
    public boolean equals(final Object o) {
        ...
        final SecondSinceEpocVirtualKey that = (SecondSinceEpocVirtualKey) o;
