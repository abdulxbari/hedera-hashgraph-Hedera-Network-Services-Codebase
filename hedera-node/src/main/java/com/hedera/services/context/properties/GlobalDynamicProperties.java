...
public class GlobalDynamicProperties {
    ...
    public void reload() {
        ...
        enableDirectHTSTokenCalls =
                properties.getBooleanProperty("contracts.enableDirectTokenCalls");
    ...
    public boolean enableDirectHTSTokenCalls() {
        return enableDirectHTSTokenCalls;
    }
