 ...
 *   <li>Third, the executor invokes {@link Precompile#run(PrecompileInfoProvider)}, which is
 *       expected to have side-effects on the {@link
 *       com.hedera.services.store.contracts.WorldLedgers} in the provided message frame.
...
public interface Precompile {
    ...
    void run(PrecompileInfoProvider precompileInfoProvider);
    ...
    default void handleSentHbars(PrecompileInfoProvider provider) {
