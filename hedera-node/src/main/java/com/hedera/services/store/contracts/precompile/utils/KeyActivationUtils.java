...
public final class KeyActivationUtils {
    ...
    public static boolean validateKey(
        ...
        if (precompileInfoProvider.isDirectTokenCall()) {
            return validateKeyForDirectCall(
                    (DirectCallsPrecompileInfoProvider) precompileInfoProvider,
                    target,
                    activationTest,
                    ledgers);
        }
        ...
        final MessageFrame frame =
                ((EVMPrecompileInfoProvider) precompileInfoProvider).messageFrame();
        return validateKeyForCallWithMessageFrame(
                frame, target, activationTest, ledgers, contractAliases);
    }
