...
public class RecordStreamV6Verifier {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (var files = Files.list(recordFilesPath)) {
            ...
            if (firstRecordFile.isPresent()) {
                firstBLockNumber =
                        RecordFileReaderV6.read(firstRecordFile.get()).blockNumber();
            }
        }
        RecordStreamConfig recordStreamConfig =
                new RecordStreamConfig(true, "", "sidecar", 2, 5000, false, 256, 6, 6, true, true);
     ...
     */
    public static Bytes validateRecordAndSignatureFile(
        ...
        final RecordStreamFile recordFile = RecordFileReaderV6.read(recordFileBytes);
